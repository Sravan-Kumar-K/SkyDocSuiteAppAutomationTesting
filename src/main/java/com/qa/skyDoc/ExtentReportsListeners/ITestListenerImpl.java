...
public class ITestListenerImpl extends ExtentReportListener implements ITestListener {
	...
	public void sendEmail(String receipient) throws EmailException {
		...
		attachment.setPath("./Extent_report/SkyDoc Automation Test Report2.html");
		...
		email.setSubject("SkyDoc Automation Test Report");
		email.setMsg("Hey, Automation testing for SkyDoc Suite app is completed. Please find the test report below");
